...
To push the changes to the repository, you will have wanted to have already committed the changes. Now, the "Git" tab will tell you how far ahead you are of the original repository you forked from. Press the green "Push" button to make the changes reflect in your forked repository on GitHub. This should run automatically.
